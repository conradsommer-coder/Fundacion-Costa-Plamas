...
interface HistoriaDetailPageProps {
  storySlug?: string;
}

const HistoriaDetailPage: React.FC<HistoriaDetailPageProps> = ({ storySlug }) => {
  ...
  if (!storyMeta || !story || typeof story !== 'object') {
    return (
      <div className="pt-32 pb-24 text-center">
        ...
        <Link href={getLocalizedPath('stories', language)} className="text-coral font-bold hover:underline">{t('storyDetail.backStories')}</Link>
      </div>
    );
  }
    ...
    <main className="flex-grow pt-24 overflow-hidden">
      <article className="bg-white">
        <div className="container mx-auto px-4 md:px-8 py-16">
          ...
          >
            <Link href={getLocalizedPath('stories', language)} className="inline-flex items-center gap-2 text-gray-500 hover:text-sea transition-colors mb-12 group">
            ...
            <div className="grid lg:grid-cols-[1fr_250px] gap-16">
              ...
              >
                ...
                >
                  ...
                  <Link href={getLocalizedPath('donate', language)} className="block text-center py-3 bg-coral text-white rounded-full font-bold hover:bg-opacity-90 transition-all shadow-lg">
                    {t('common.donateNow')}
                  </Link>
                </motion.div>
              </motion.aside>
                ...
                {Object.entries(stories)
                  ...
                  .map(([key, storyListMeta], i) => {
                    ...
                    return (
                      ...
                      >
                        <Link href={getLocalizedPath('story', language, { storyId: key })} className="group">
